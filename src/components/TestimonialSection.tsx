  ...
  const testimonials = [
    {
      ...
      content: "aitamate's training program transformed our team's capabilities. We've seen a 60% improvement in project efficiency and our developers are now confidently implementing AI solutions.",
      rating: 5,
