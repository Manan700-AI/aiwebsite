  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Welcome to the AI-tamate newsletter. You'll receive our next update soon."
      });
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg p-6 shadow-lg">
              <p className="text-gray-600 mb-4">
                "The AI-tamate newsletter is my go-to source for staying current with AI trends. 
