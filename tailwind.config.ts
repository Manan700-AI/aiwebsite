	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Custom colors for Pulse Robot - Changed to blue theme
				pulse: {
					"50": "#eff6ff",
					"100": "#dbeafe",
					"200": "#bfdbfe",
			...
			backgroundImage: {
				'hero-gradient': 'linear-gradient(90deg, hsla(217, 91%, 83%, 1) 0%, hsla(243, 91%, 68%, 1) 100%)',
				'hero-gradient-2': 'linear-gradient(90deg, hsla(215, 100%, 77%, 1) 0%, hsla(217, 90%, 57%, 1) 100%)',
